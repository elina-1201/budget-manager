import 'package:budget_manager/src/core/database/database_provider.dart';
import 'package:budget_manager/src/core/http/dio_provider.dart';
import 'package:budget_manager/src/core/storage/auth_state.dart';
...
import 'package:budget_manager/src/data/repositories/category_repository_local.dart';
import 'package:budget_manager/src/data/repositories/category_repository_remote.dart';
import 'package:budget_manager/src/data/repositories/expense_repository.dart';
import 'package:budget_manager/src/data/repositories/expense_repository_local.dart';
import 'package:budget_manager/src/data/repositories/expense_repository_remote.dart';
